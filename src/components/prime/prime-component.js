...
import { faFacebookSquare,faLinkedin,faSquareInstagram,faTwitterSquare } from "@fortawesome/free-brands-svg-icons";

export function PrimeComponent() {
    return (
        <>
            <div id="header">
                <div className="container">
                    <div className="row">
                        <div className="col-md-4">
                            <h1 id="logo">Prime 1 Business</h1>
                        </div>
                        <div className="col-md-8">
                            <ul id="menu">
                                ...
                                <li><a href="connect-page">Connect Page</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 col-lg-3">
                        <div className="news-post">
                            ...
                            <div className="post-date"><FontAwesomeIcon icon={faCalendar} /> February 20, 2024</div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-6 col-md-4">
                            <div className="footer-widget">
                                ...
                                <address>
                                    <b>Prime 1 Business</b><br />
                                    455 Company Road,  Nagar<br />
                                    MUMBAI, INDIA 133001<br />
                                    P : (123) 456-7890
                                </address>
                            </div>
                        </div>
            ...
            <div id="footer">
                <div className="container">
                    <div className="row">
                        <div className="col-md-6">prime1@2024 company name.</div>
                        <div className="col-md-6">
                            <ul id="social-icons">
                                <li><a href="facebook"><FontAwesomeIcon icon={faFacebookSquare} /></a></li>
                                <li><a href="instagram"><FontAwesomeIcon icon={faSquareInstagram} /></a></li>
